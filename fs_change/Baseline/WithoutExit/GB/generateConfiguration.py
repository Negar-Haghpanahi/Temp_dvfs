        ...
        for num_exits in exits:
            ...
            for tree_splits in list_tree_splits:
                for proportions in list_data_percentages:
                    dictionary = {'dataset_name': dataset_name, 'Num_exits': num_exits, 'max_depth': depth, 'tree_splits': tree_splits, 'split_points': proportions, 'fs_base': fs_base, 'th': th_combinations, 'gamma': gamma_combinations, 'n_estimators': n_est}
                    l.append(dictionary)
...
def generate_configurations_Baseline_NoExit_GB(dataset_name):
    l=[]
    # dataset_name = dataset_name[0]    
...
def generate_configurations_Baseline_NoExit_RF(dataset_name):
    l=[]
    # dataset_name = dataset_name[0]    
