...
from models.dynamic_early_exit import DynamicEarlyExitRF
...
def parse_args():
    ...
    p.add_argument("--n_est", type=int, default=70)
    p.add_argument("--max_depth", type=int, default=20)
    p.add_argument("--num_exits", type=int, default=2)

    p.add_argument("--tree_splits", type=float, nargs="+", default=[0.31 , 1.0])
    p.add_argument("--proportions", type=float, nargs="+", default=[0.41, 1.0])   # split_points
    p.add_argument("--th_combination", type=float, nargs="+", default=[0.4479398673070137])  
    return p.parse_args()
...
if __name__ == "__main__":
    ...
    # ===== SAVE =====
    save_dir = Path("PKL_Saved_Files/margin1.5/RF")
    ...
    # def parse_args():
        ...
        # p.add_argument("--tree_splits", type=float, nargs="+", default=[0.33, 0.49, 0.64, 1])
        # p.add_argument("--proportions", type=float, nargs="+", default=[0.37, 0.53, 0.68, 1])   # split_points
        # p.add_argument("--th_combination", type=float, nargs="+", default=[0.34657359027997264, 1.3862943611198906, 0.6931471805599453])    # th_list
    ...
    #     p.add_argument("--th_combination", type=float, nargs="+", default=[0.4479398673070137])    # th_list
    ...
    #     p.add_argument("--tree_splits", type=float, nargs="+", default=[0.31, 1])
    #     p.add_argument("--proportions", type=float, nargs="+", default=[0.41, 1])   # split_points
    #     p.add_argument("--th_combination", type=float, nargs="+", default=[0.48647753726382825])    # th_lis
        ...
        # p.add_argument("--tree_splits", type=float, nargs="+", default=[0.47, 1])
        # p.add_argument("--proportions", type=float, nargs="+", default=[0.36, 1])   # split_points
        # p.add_argument("--th_combination", type=float, nargs="+", default=[0.17328])   
    ...
    #     p.add_argument("--tree_splits", type=float, nargs="+", default=[0.47, 1])
    #     p.add_argument("--proportions", type=float, nargs="+", default=[0.36, 1])   # split_points
    #     p.add_argument("--th_combination", type=float, nargs="+", default=[0.34657359027997264])    # th_list 
    ...
    #         return p.parse_args()
        ...
        # p.add_argument("--tree_splits", type=float, nargs="+", default=[0.31, 0.56, 1])
        # p.add_argument("--proportions", type=float, nargs="+", default=[0.41 ,0.62, 1])   # split_points
        # p.add_argument("--th_combination", type=float, nargs="+", default=[0.6931471805599453, 0.34657359027997264])    # th_list
...
#p = argparse.ArgumentParser()
    ...
    # p.add_argument("--tree_splits", type=float, nargs="+", default=[0.31,  1])
    # p.add_argument("--proportions", type=float, nargs="+", default=[0.41, 1])   # split_points
    # p.add_argument("--th_combination", type=float, nargs="+", default=[0.5198603854199589])    # th_list
#     return p.parse_args()
